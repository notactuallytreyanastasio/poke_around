defmodule PokeAroundWeb.Router do
  use PokeAroundWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {PokeAroundWeb.Layouts, :root}
  ...
  if Application.compile_env(:poke_around, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: PokeAroundWeb.Telemetry
